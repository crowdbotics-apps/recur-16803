...
admin.site.site_header = "recur"
admin.site.site_title = "recur Admin Portal"
admin.site.index_title = "recur Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="recur API",
        default_version="v1",
        description="API documentation for recur App",
    ),
    public=True,
